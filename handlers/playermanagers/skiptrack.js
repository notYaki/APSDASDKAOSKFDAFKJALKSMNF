  ...
  try {
    ...
    try {
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`<:713400011714723932:891458936656515092> There was an error while searching:`)
    ...
    if (!res.tracks[0])
      return message.channel.send(new MessageEmbed()
        .setColor(ee.wrongcolor)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(String("<:713400011714723932:891458936656515092> Found nothing for: **`" + search).substr(0, 256 - 3) + "`**")
