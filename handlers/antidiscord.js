            ...
            try {
                ...
                if (content.includes('discord.gg/')) {
                    ...
                    if (!isOurInvite) {
                        ...
                        message.delete().catch(e => console.log("PREVENTED A BUG"))
                        ...
                        if (Number(countermap.get(message.author.id)) > 5) {
                            ...
                            return message.channel.send(new MessageEmbed()
                                ...
                                .setFooter(es.footertext, es.footericon)
                                .setTitle(`<:713400011714723932:891458936656515092> You are not allowed to send Discord related Links in this Channel`)
                            ).then(msg => msg.delete({
                                timeout: 3000
