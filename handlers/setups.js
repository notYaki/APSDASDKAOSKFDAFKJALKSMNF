    ...
    function getAll(client, guild) {    
        const embed = new MessageEmbed()
            ...
            .setTitle('Help Menu - THANKS FOR INVITING ME!')
                ...
                >>> <@442355791412854784> \`Ÿακι ジ#4635\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
