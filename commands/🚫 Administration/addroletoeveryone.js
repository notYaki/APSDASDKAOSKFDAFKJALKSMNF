      ...
      return message.channel.send(new Discord.MessageEmbed()
       ...
       if (map.get(message.guild.id))
         return message.channel.send(new MessageEmbed()
           .setColor(es.wrongcolor)
           .setFooter(es.footertext, es.footericon)
           .setTitle(`<:713400011714723932:891458936656515092> There is an active \`addroletoeveryone\` Command already executing in this Server!`)
         );
       ...
       if (message.member.roles.highest.position <= role.position)
         return message.channel.send(new MessageEmbed()
           .setColor(es.wrongcolor)
           .setFooter(es.footertext, es.footericon)
           .setTitle(`<:713400011714723932:891458936656515092> I cannot give that Role to all Members, because it's higher then your highest ROLE!`)
         );
