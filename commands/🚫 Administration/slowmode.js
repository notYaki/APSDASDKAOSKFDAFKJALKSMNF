  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.channel.send(new Discord.MessageEmbed()
        ...
        .setTitle("<:713400011714723932:891458936656515092> I am missing the permission to `MANAGE CHANNELS`!")
      )
      ...
      if (!isNaN(args[0]) || parseInt(args[0]) < 0) {
        ...
        message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:762633663266553857:891459306195664898> Set Slowmode to: ${args[0]}!`)
        );
        ...
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> Your Input is not a Number, please retry!`)
