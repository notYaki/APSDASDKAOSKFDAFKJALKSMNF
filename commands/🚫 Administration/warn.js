    ...
    try {
      ...
      if (!warnmember)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> Please add a Member you want to warn!`)
      ...
      try {
        ...
        message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<a:762633663266553857:891459306195664898> Warned ${warnmember.user.tag}`)
