    ...
    try {
      ...
      if (member.roles.highest.position >= message.member.roles.highest.position)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> I cannot give that Role to this Member, because he is higher/Equal to your Rang Position!`)
        );
      if (message.member.roles.highest.position <= role.position)
        return message.channel.send({embed: new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> I cannot give that Role to this Member, because it's higher then your highest ROLE!`)
        });
      if (member.roles.cache.some(r => r.id == (role.id)))
        return message.channel.send({embed: new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> I cannot give that Role to this Member, because he already has it!!`)
        });
      var ge = false;
      ...
      message.channel.send({embed: new MessageEmbed()
        ...
        .setFooter(es.footertext, es.footericon)
        .setTitle(`<a:762633663266553857:891459306195664898> added \`${role.name}\` to \`${member.user.tag}\``)
      });
