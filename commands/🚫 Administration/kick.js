  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.channel.send(new Discord.MessageEmbed()
        ...
        .setTitle("<:713400011714723932:891458936656515092> I am missing the permission to `KICK MEMBERS`!")
      )
      ...
      if (!kickmember)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> Please add a Member you want to kick!`)
      ...
      if (moderationPosition <= memberPosition)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> I cannot kick someone, who is above/equal you`)
        );
      ...
      if (!kickmember.kickable)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> The Member is not kickable, sorry!`)
        );
        ...
        try{
          kickmember.send(new MessageEmbed()
            ...
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<a:762633663266553857:891459306195664898> You got kicked by \`${message.author.tag}\` from \`${message.guild.name}\` for ${days === 0 ? `Infinite Days` : `${days} Days`}`)
          ...
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<:713400011714723932:891458936656515092> Could not DM the Reason to: \`${kickmember.user.tag}\``)
      ...
      try {
        kickmember.kick({
          ...
          message.channel.send(new MessageEmbed()
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<a:762633663266553857:891459306195664898> Kicked ${kickmember.user.tag}`)
            .setDescription(`Reason:\n> ${reason}`)
          );
