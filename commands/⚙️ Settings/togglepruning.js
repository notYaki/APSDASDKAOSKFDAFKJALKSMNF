...
module.exports = {
    ...
    try{
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`<a:762633663266553857:891459306195664898> ${client.settings.get(message.guild.id, `pruning`) ? `${emoji.msg.enabled} Enabled` : `${emoji.msg.ERROR} Disabled`} Pruning`)
