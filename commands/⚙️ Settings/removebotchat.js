...
module.exports = {
    ...
    try{
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`<:713400011714723932:891458936656515092> Please add a Channel via ping, for example: #channel!`)
      );
      ...
      try {
        ...
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:713400011714723932:891458936656515092> It seems that the Channel does not exist in this Server!`)
        );
      }
      ...
      if(!client.settings.get(message.guild.id,`botchannel`).includes(channel.id))
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:713400011714723932:891458936656515092> This Channel is not in the Bot Channel Settings!`)
        );
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setFooter(es.footertext, es.footericon)
        .setTitle(`<a:762633663266553857:891459306195664898> Removed the Bot-Chat \`${channel.name}\``)
