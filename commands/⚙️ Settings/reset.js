    ...
    try{
      ...
      if (message.member.guild.owner.id !== message.author.id)
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:713400011714723932:891458936656515092> You don\'t have permission for this Command! *Only the Server-Owner*`)
        );
      //ask for second yes
        ...
        .then(async collected => {
          ...
          if(collected.first().content.toLowerCase() === `yes`)
          {
            ...
            return message.channel.send(new MessageEmbed()
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              .setFooter(es.footertext, es.footericon)
              .setTitle(`<a:762633663266553857:891459306195664898> Resetted everything!`)
          ...
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<:713400011714723932:891458936656515092> CANCELLED CAUSE NOT THE RIGHT WORD / TIME RAN OUT!`)
          );
        })
      });
    } catch (e) {
