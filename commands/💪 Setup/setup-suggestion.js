...
*React with the Right Emoji according to the Right action*`).setFooter(es.footertext, es.footericon)
      ...
      /**
            suggest: {
              channel: "",
              approvemsg: `<a:762633663266553857:891459306195664898> Accepted Idea! Expect this soon.`,
              denymsg: `<:713400011714723932:891458936656515092> Thank you for the feedback, but we are not interested in this idea at this time.`,
          ...
          .then(collected => {
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> The Channel: \`${channel.name}\` is now registered as the Suggestion Channel`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                console.log(e)
                return message.reply(new Discord.MessageEmbed()
                  .setTitle("<:713400011714723932:891458936656515092> ERROR | Something went wrong, please contact: ``")
                  .setColor(es.wrongcolor)
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I changed the Approve Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I changed the Deny Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I changed the Maybe Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I changed the Status Text to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I changed the Footer Text to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
            ...
            if (reaction) {
              try {
                if (collected.first().emoji.id && collected.first().emoji.id.length > 2) {
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:762633663266553857:891459306195664898> Successfully changed the Approve emoji`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`\`\`\`${String(JSON.stringify(e)).substr(0, 2000)}\`\`\``)
                    .setFooter(es.footertext, es.footericon)
                  );
            ...
            if (reaction) {
              try {
                if (collected.first().emoji.id && collected.first().emoji.id.length > 2) {
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:762633663266553857:891459306195664898> Successfully changed the Deny emoji`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`\`\`\`${String(JSON.stringify(e)).substr(0, 2000)}\`\`\``)
                    .setFooter(es.footertext, es.footericon)
                  );
