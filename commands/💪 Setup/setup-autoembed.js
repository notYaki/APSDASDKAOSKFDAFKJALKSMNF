          ...
          .then(collected => {
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:713400011714723932:891458936656515092> The Channel is already defined as an Auto Embed Channel`)
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I will now replace every message in \`${channel.name}\` too!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
          ...
          .then(collected => {
            ...
            if (channel) {
              try {
                ...
                if(!a.includes(channel.id))
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:713400011714723932:891458936656515092> The Channel is not defined as an Auto Embed Channel yet`)
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I will now no longer replace the messages in \`${channel.name}\`!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
