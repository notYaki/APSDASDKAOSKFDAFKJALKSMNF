    ...
    try {
        ...
        .then(async collected => {
          ...
          if(channel){
            if(!channel.nsfw || channel.nsfw == undefined){
              return message.reply(new Discord.MessageEmbed()
                .setTitle("<:713400011714723932:891458936656515092> ERROR | The Pinged Channel is not a NSFW Channel")
                .setColor(es.wrongcolor)
                .setDescription(`Cancelled the Operation!`.substr(0, 2000))
                .setFooter(es.footertext, es.footericon)
              );
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<a:762633663266553857:891459306195664898> The Channel: \`${channel.name}\` is now registered as the Auto Nsfw Poster Channel`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<a:762633663266553857:891459306195664898> Disabled the Auto Nsfw Poster Channel`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a:762633663266553857:891459306195664898> Settings of the Auto Nsfw Poster Channel`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
