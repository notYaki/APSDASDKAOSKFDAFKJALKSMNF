    ...
    try {
      ...
      if (temptype == "set") {
          ...
          .then(collected => {
            ...
            if (message.content) {
              ...
              if(userpercent > 100 || userpercent < 0) 
                return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle("<:713400011714723932:891458936656515092> ERROR | Percent out of Range!")
                    .setColor(es.wrongcolor)
              ...
              try {
                ...
                return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> The Anticaps system is now enabled!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        try {
          ...
          return message.reply({embed: new Discord.MessageEmbed()
            .setTitle(`<a:762633663266553857:891459306195664898> The AntiCaps System is now **disabled**`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
