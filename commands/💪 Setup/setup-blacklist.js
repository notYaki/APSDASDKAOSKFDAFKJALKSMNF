  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if (temptype == "add") {
          ...
          .then(collected => {
            ...
            if (message.content) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> Added \`${blacklistedwords.length - notadded.length}\` / \`${blacklistedwords.length}\``)
          ...
          .then(collected => {
            ...
            if (message.content) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> Removed \`${blacklistedwords.length - notremoved.length}\` / \`${blacklistedwords.length}\``)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a:762633663266553857:891459306195664898> Resetted the Blacklist`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        );
      } else {
