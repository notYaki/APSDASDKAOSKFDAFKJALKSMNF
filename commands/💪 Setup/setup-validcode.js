    ...
    try {
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<:713400011714723932:891458936656515092> Missing Permission to add Reactions")
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<:713400011714723932:891458936656515092> Your Time ran out")
          .setColor(es.wrongcolor)
        ...
        if(temptype == "toggle"){
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<a:762633663266553857:891459306195664898> The Valid Code Setup is now ${d2p(client.settings.get(message.guild.id, `validcode`))}!`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            .setFooter(es.footertext, es.footericon)
          );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<:713400011714723932:891458936656515092> PLEASE CONTACT `Ÿακι ジ#4635`")
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
