...
*React with the Right Emoji according to the Right action*`).setFooter(es.footertext, es.footericon)
      ...
      if (temptype == "set") {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(async collected => {
            ...
            if(msg && msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first()){
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<a:762633663266553857:891459306195664898> I will now send all Youtube Notifications in \`${msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first().name}\``)
        ...
        if(client.social_log.get(message.guild.id, "youtube.channels").length >= 5) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:713400011714723932:891458936656515092> ERROR | You've reached the maximum amount of youtube Channels (5)")
            .setColor(es.wrongcolor)
...
https://www.youtube.com/channel/UC1AgotpFHNhzolUtAjPgZqQ`)
          ...
          .then(async collected => {
            ...
            if(msg && msg.content ){
              ...
              if(client.social_log.get(message.guild.id, "youtube.channels").includes(msg.content))
                return message.reply(new Discord.MessageEmbed()
                  .setTitle("<:713400011714723932:891458936656515092> ERROR | The Youtube Channel is already setup!")
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                );
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<a:762633663266553857:891459306195664898> added the Channel ${msg.content}`)
        ...
        if(client.social_log.get(message.guild.id, "youtube.channels").length <= 0) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:713400011714723932:891458936656515092> ERROR | You havent setup any Youtube Channels yet!")
            .setColor(es.wrongcolor)
        ...
        await tempmsg.awaitReactions((reaction, user) => user.id == message.author.id && emojis.includes(reaction.emoji.name), {
          ...
          .then(async collected => {
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<a:762633663266553857:891459306195664898> removed the Channel ${channel}`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              .setFooter(es.footertext, es.footericon)
            );
          })
...
> \`{date}\` ... will be replaced with the video's **date**`)
            ...
            .then(async collected => {
              ...
              if(msg && msg.content ){
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> Changed the message for the Channel ${channel}`)
