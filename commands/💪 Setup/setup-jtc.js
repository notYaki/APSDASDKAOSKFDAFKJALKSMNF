    ...
    try{
      var adminroles = client.settings.get(message.guild.id, "adminroles")
        ...
        *React with the Right Emoji according to the Right action*`)
          ...
          .then(async collected => {
            ...
            //Use the Current CHANNEL
              ...
              if (!channel) return message.reply(new Discord.MessageEmbed()
                  .setTitle("<:713400011714723932:891458936656515092> You are not connected to a Channel")
                  .setColor(es.wrongcolor)
        ...
        //Channel Setup 3, Yaki's Dick is huge
        else if (temptype == "3") {
        ...
        //Else do THAT
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:713400011714723932:891458936656515092> ERROR | PLEASE CONTACT `Yaki#6966`")
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
          );
        }
...
/**
  * @INFO
  * Bot Coded by Yaki#6966 | https://github.com/Yaki6966/Discord-Js-Handler-Template
  * @INFO
