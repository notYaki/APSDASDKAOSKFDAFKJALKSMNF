    ...
    try {
      ...
      if (temptype == "add") {
        if (client.keyword.get(message.guild.id, "commands").length > 19)
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:713400011714723932:891458936656515092> ERROR | You've reached the maximum Key Words Amount!")
            .setColor(es.wrongcolor)
          ...
          .then(collected => {
            ...
            if (reaction) {
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:762633663266553857:891459306195664898> I successfully deleted \`${thecmd.name}\`!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
        ...
        for (let i = 0; i < cuc.length; i++) {
          try {
            ...
            embed.addField(`<a:768934598583123979:891462739791323187> \`${cuc[i].name}\` | ${cuc[i].embed ? "✅ Embed" : "❌ Embed"}`, ">>> <a:768934598583123979:891462739791323187> **__OUTPUT__**\n" + string + "\n<a:768934598583123979:891462739791323187> **__ALIASES__**\n" + aliases + "\n<a:768934598583123979:891462739791323187> **__CHANNELS__**\n" + channels)
          } catch (e) {
            console.log(e)
          }
        }
