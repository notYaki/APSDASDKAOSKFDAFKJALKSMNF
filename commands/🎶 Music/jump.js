    ...
    try {
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<:713400011714723932:891458936656515092> Please include to which track you want to jump`)
      ...
      if (isNaN(args[0]))
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<:713400011714723932:891458936656515092> It has to be a queue **Number**`)
        );
      ...
      if (Number(args[0]) > player.queue.size)
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<:713400011714723932:891458936656515092> That song is not in the queue, sorry!`)
        );
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle(`<a:762633663266553857:891459306195664898> Jumped to the: \`${args[0]}\` Song`)
