  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(!user && args[0] && args[0].length == 18) {
        ...
        if(!user || user == null || !user.id) return message.reply("<:713400011714723932:891458936656515092> I failed finding that User...")
      }
      else {
      ...
      let attachment = await new MessageAttachment(image, "ohno.png");
