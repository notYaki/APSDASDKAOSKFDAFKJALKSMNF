...
module.exports = {
  ...
  description: "Changes if the Advertisement of Yaki Should be there or NOT",
      ...
      if (timeouterror)
        ...
        if (temptype == "toggle") {
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<a:762633663266553857:891459306195664898> The Yaki Advertisement System is now ${d2p(client.adenabled)}!`)
          ...
          .setTitle(`📑 Settings of the Yaki Advertisement System`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
