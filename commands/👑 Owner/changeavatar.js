    ...
    try {
      ...
      if (message.attachments.size > 0) {
        if (message.attachments.every(attachIsImage)) {
          ...
          .then(user => {
            return message.channel.send(new MessageEmbed()
            .setTitle(`<a:762633663266553857:891459306195664898> Successfully, changed the Bot avatar!`)
            .setColor(es.color)
            .setFooter(es.footertext, es.footericon)
          );
          })
          ...
          return message.channel.send(new MessageEmbed()
            .setTitle(`<:713400011714723932:891458936656515092> ERROR | Could not use your Image as an Avatar, make sure it is a \`png\` / \`jpg\``)
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
          );
        }
        ...
        return message.channel.send(new MessageEmbed()
            .setTitle(`<:713400011714723932:891458936656515092> ERROR | Could not use your Image as an Avatar, make sure it is a \`png\` / \`jpg\` / \`webp\``)
