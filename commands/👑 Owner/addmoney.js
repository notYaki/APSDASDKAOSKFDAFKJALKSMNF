...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    return message.channel.send(new MessageEmbed()
        .setColor(es.wrongcolor)
        .setFooter(user.tag, user.displayAvatarURL({dynamic: true}))
        .setTitle(`<:713400011714723932:891458936656515092> You can't add a negative Amount of Money or no Money, to ${topay}`)
      );
    ...
    return message.reply(new MessageEmbed()
      .setColor(es.color)
      .setFooter(user.tag, user.displayAvatarURL({dynamic: true}))
      .setTitle(`<a:762633663266553857:891459306195664898> **You added \`${payamount} 💸\` to \`${topay.tag}\`**`)
