          ...
          .then(async collected => {
            ...
            if (!isValidURL(msg))
              return message.channel.send({embed: new MessageEmbed()
                .setFooter(es.footertext, es.footericon)
                .setColor(es.wrongcolor)
                .setTitle(`<:713400011714723932:891458936656515092> NOT A VALID URL`)
              })
            if (!msg.includes("twitch"))
              return message.channel.send({embed: new MessageEmbed()
                .setFooter(es.footertext, es.footericon)
                .setColor(es.wrongcolor)
                .setTitle(`<:713400011714723932:891458936656515092> NOT A VALID TWITCH URL`)
              })
            let status = config
...
/**
 * @INFO
 * Bot Coded by Ÿακι ジ#4635#6966 | https://github.com/Ÿακι ジ#46356966/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
