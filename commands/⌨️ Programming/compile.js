		...
		try {
			...
			if (!lang || !code) 
				return message.channel.send({embed: new MessageEmbed()
					...
					.setTitle(`<:713400011714723932:891458936656515092> You didn't provide a Valid Code`)
			...
			if (!possiblecommands[lang]) 
				return message.channel.send({embed: new MessageEmbed()
					.setColor(es.wrongcolor)
					.setFooter(es.footertext, es.footericon)
					.setTitle(`<:713400011714723932:891458936656515092> You provide an Invalid Language`)
