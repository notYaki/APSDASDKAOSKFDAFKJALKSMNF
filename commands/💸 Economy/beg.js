    ...
    try {
      ...
      if (data.beg !== 0 && timeout - (Date.now() - data.beg) > 0) {
        ...
        return message.reply({
          embed: new MessageEmbed()
            ...
            .setTitle(`<a:865963806483808256:896694904019894282> You've already collected your beg reward!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(message.author.tag, message.author.displayAvatarURL({ dynamic: true }))
          .setTitle(`<a:762633663266553857:891459306195664898> You've Collected Your Beg Reward Of \`${amount} 💸\``)
