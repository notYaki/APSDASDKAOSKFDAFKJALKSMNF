    ...
    try {
      ...
      if(data.daily !== 0 && timeout - (Date.now() - data.daily) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<:713400011714723932:891458936656515092> You've already collected your daily reward!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(message.author.tag, message.author.displayAvatarURL({dynamic: true}))
          .setTitle(`<a:762633663266553857:891459306195664898> You've collected your daily reward of \`${amount} 💸\``)
