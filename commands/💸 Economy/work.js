    ...
    try {
      ...
      if(data.work !== 0 && timeout - (Date.now() - data.work) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<:713400011714723932:891458936656515092> You've already worked recently!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(user.tag, user.displayAvatarURL({dynamic: true}))
          .setTitle(`<a:762633663266553857:891459306195664898> You worked as a **${replies[result]}** and earned \`${nFormatter(amount)} 💸\``)
