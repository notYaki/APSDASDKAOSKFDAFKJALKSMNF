    ...
    let amountofbuy = Number(args[1]) || 1;
      if (amountofbuy == 0)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(user.tag, user.displayAvatarURL({ dynamic: true }))
          .setTitle(`<:713400011714723932:891458936656515092> You cannot sell 0 Items`)
      ...
      if(data.items[`${args[0].toLowerCase()}`] == 0)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(user.tag, user.displayAvatarURL({ dynamic: true }))
          .setTitle(`<:713400011714723932:891458936656515092> You cannot sell an Item which you don't have`)
      ...
      if (amountofbuy > data.items[`${args[0].toLowerCase()}`])
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(user.tag, user.displayAvatarURL({ dynamic: true }))
          .setTitle(`<:713400011714723932:891458936656515092> You cannot sell More ${args[0]} then you have (\`${ data.items[`${args[0].toLowerCase()}`]}\`)`)
      ...
      return message.channel.send(new MessageEmbed()
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        .setFooter(user.tag, user.displayAvatarURL({ dynamic: true }))
        .setTitle(`<a:762633663266553857:891459306195664898> **Successfully sold ${nFormatter(amountofbuy)} ${args[0]} for \`${nFormatter(endprize)} 💸\`**`)
