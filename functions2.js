    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            collector.on("collect", async (reaction, user) => {
                ...
                if (!member.hasPermission("ADMINISTRATOR") && djrolefromenmap && !member.roles.cache.has(djrolefromenmap.id)) return embedbuilder(5000, reaction.message, config.colors.no, "DJ-ROLE", `<:713400011714723932:891458936656515092> You don\'t have permission for this Command! You need to have: ${djrolefromenmap}`)
