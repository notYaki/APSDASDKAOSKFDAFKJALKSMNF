...
module.exports = {
    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            .addField("♾ Loop:", `>>> ${queue.repeatMode ? queue.repeatMode === 2 ? "<a:762633663266553857:891459306195664898> Queue" : "<a:762633663266553857:891459306195664898> Song" : "<:713400011714723932:891458936656515092>"}`, true)
            .addField("↪️ Autoplay:", `>>> ${queue.autoplay ? "<a:762633663266553857:891459306195664898>" : "<:713400011714723932:891458936656515092>"}`, true)
            .addField("❔ Filter:", `>>> \`${queue.filter || "<:713400011714723932:891458936656515092>"}\``, true)
            ...
            collector.on("collect", async (reaction, user) => {
                ...
                if (!member.hasPermission("ADMINISTRATOR") && djrolefromenmap && !member.roles.cache.has(djrolefromenmap.id)) return embedbuilder(client,5000, reaction.message, config.colors.no, "DJ-ROLE", `<:713400011714723932:891458936656515092> You don\'t have permission for this Command! You need to have: ${djrolefromenmap}`)
